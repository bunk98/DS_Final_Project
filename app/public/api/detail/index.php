...
$vars = [];
 ...
 if (isset($_GET['student'])) {
   ...
   $sql = 'SELECT CONCAT(r.firstname, " ", r.lastname) as referee, g.game_name as game, rg.rg_status as rg_status, rg.position as position, rg.rgID as rgID  FROM Ref_Game as rg JOIN Referee as r on rg.refereeID = r.refereeID JOIN Game as g on rg.gameID = g.gameID WHERE rg.refereeID = ?';
   $vars = [ $_GET['student'] ];
 }
